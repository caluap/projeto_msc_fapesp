...
{\color{pos_parecer}
    ...
    \noindent{\large{\textit{Abaixo, adicionamos duas seções relatando os avanços no projeto entre a escrita do projeto como submetido para a Fapesp, em meados de setembro de 2018, e o ponto atual, em meados de março de 2019.}}}
    ...
    \begin{figure}
        \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{fig/cards_2.png}}%
